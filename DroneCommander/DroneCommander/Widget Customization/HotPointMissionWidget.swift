//
//  HotPointMissionWidget.swift
//  DroneCommander
//
//  Created by Jerry Walton on 3/4/18.
...
class HotPointMissionWidget: DULWidget {
    ...
    override func prepare() { // This is - (void)prepareWidget in Objective-C
        ...
        button.setImage(UIImage(named: IconHotPointMission), for: UIControlState.normal)
    ...
    {
        print("Button tapped")
        NotificationCenter.default.post(name: Notification.Name(rawValue: NotifShowHotPointMissionView), object: nil)
    }

...
class ShotSheetWidget: DULWidget {
    ...
    override func prepare() { // This is - (void)prepareWidget in Objective-C
        ...
        button.setImage(UIImage(named: IconShotSheet), for: UIControlState.normal)
    ...
    {
        print("Button tapped")
        NotificationCenter.default.post(name: Notification.Name(rawValue: NotifShowShotSheetView), object: nil)
    }
